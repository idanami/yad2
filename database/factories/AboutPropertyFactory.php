...
class AboutPropertyFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'settlement' => $this->faker->realText($maxNbChars = 12, $indexSize = 1),
            'street' => $this->faker->realText($maxNbChars = 12, $indexSize = 2),
            'house_number' => $this->faker->numberBetween($min = 1, $max = 250),
            'property_type' => $this->faker->text($maxNbChars = 8),
